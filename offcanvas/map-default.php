...
<div class="off-canvas position-left reveal-for-large reveal-turned-off" id="offCanvasMap" data-off-canvas>
	...
	[stratum_map account=5 listing_url_template="https://eordisplay.teamstratum.com/listings/{{slug}}" info_max_width=250 recenter_on_update=1 show_all_results='Center']
	
	<div class="map-pagination">
		[stratum_pagination account=5]
	</div>
