...
<form method="get" action="https://comdisplay.teamstratum.com/results">

<div class="search-bar grid-container" role="search">
	<div class="grid-x alignment-center">
		<div class="cell medium-11 large-8">
				<?php 
					echo do_shortcode( '[stratum_search account=65 placeholder="Search" listing_url_template="https://comdisplay.teamstratum.com/listings/{{slug}}"]' );
				?>
			</div>
