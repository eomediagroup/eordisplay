 ...
 * grid layout search results on a Seller Page
 *
 */
?>
...
<div class="cell large-9">
	...
	[stratum_results account=<?= $spaccount ?> listing_url_template="https://eastoregonrealestate.com/listing/{{field:author}}/{{slug}}" num=<?= $spdisplaytotal ?>]
