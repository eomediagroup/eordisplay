<?php
/**
 * The template part for displaying a Directed Seacrh Page's SEO titles, descriptions
...
<?php ob_start(); ?>
	...
	<meta name="description" content="<?php the_field('directed-search-page-tagline'); ?>">
	...
	<meta name="twitter:image" content="<?php the_field('directed-search-page-cover-photo-url'); ?>">
